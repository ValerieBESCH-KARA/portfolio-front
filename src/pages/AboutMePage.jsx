      ...
      <div className="infoMeBloc">
        <div className="infoMe">
          <p>
            ...
            compte en tant qu'ostéopathe sur Lyon avant de m'arrêter suite au
            covid pour éléver mes 2 enfants. Je suis actuellement en pleine
            reconversion professionnelle pour devenir développeur web.
          </p>
          <p>
            ...
            une formation de 6 mois avec l'école "Le Reacteur" afin de poser de
            vraies bases et d'acquérir de nouvelles compétences.
          </p>
          <p>
